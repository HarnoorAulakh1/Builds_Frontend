    ...
    <>
      {data.username == username ? (
        <div onClick={expand}>
          ...
          <div style={{transition:".2s",borderRadius:".5rem",padding:display?".3rem":"0",position:"relative",height:display?"4rem":"0",zIndex:"10",backgroundColor:"black",overflow:"hidden"}}>
